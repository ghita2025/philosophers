...
/*   Updated: 2025/03/20 17:39:31 by gstitou          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void creat_semaphores(t_data *data)
{
    ...
    data->death_semaphore = sem_open("/death_semaphore", O_CREAT, 0644, 0);
    data->all_eat_sem = sem_open("/all_eat_sem", O_CREAT, 0644, 0);

    if (data->meal_semaphore == SEM_FAILED || data->print_semaphore == SEM_FAILED ||
